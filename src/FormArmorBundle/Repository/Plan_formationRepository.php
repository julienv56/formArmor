 ...
 */
class Plan_formationRepository extends EntityRepository
{
	public function listePlans($page, $nbParPage)
	{
		...
		// Ici, il vaut donc OC\FormArmorBundle\Entity\Plan_formation
		...
		$query
		  // On définit le plan de formation à partir duquel commencer la liste
		  ->setFirstResult(($page-1) * $nbParPage)
		  // Ainsi que le nombre de plans de formation à afficher sur une page
	...
	public function suppPlanFormation($id) // Suppression du plan de formation d'identifiant $id
	{
		$qb = $this->createQueryBuilder('f');
		$query = $qb->delete('FormArmorBundle\Entity\Plan_formation', 'p')
            ->andWhere('p.id = :id')
		  ->setParameter('id', $id);
